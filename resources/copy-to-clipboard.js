    ...
    ;[].slice.call(document.querySelectorAll('.doc pre.highlight, .doc .literalblock pre')).forEach(function (pre) {
      ...
      if (supportsCopy) {
        ...
        if (svgAs === 'svg') {
          ...
          use.setAttribute('href', 'https://cdn.jsdelivr.net/gh/sbaker-cs/Documentation@master/resources/img/octicons-16.svg#icon-clippy')
          svg.appendChild(use)
          copy.appendChild(svg)
        } else {
          var img = document.createElement('img')
          img.src = 'https://cdn.jsdelivr.net/gh/sbaker-cs/Documentation@master/resources/img/octicons-16.svg#view-clippy'
          img.alt = 'copy icon'
