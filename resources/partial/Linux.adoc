...
[source, bash]
----
optimize-vhd "~\AppData\Local\Packages\<distro>\LocalState\ext4.vhdx" -Mode full
----

[NOTE]
====
Distro name is not based on WSL's name +
eg: `CanonicalGroupLimited.Ubuntu_79rhkp1fndgsc`
====
